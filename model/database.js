...
const con = mysql.createConnection({
  ...
  user: DB_USER || "root",
  password: DB_PASS,
  database: DB_NAME || "makanbah", // dont forget to change this
...
con.connect(function(err) {
  ...
  let sql = "DROP database IF exists `makanbah`; create database makanbah; use makanbah;"
  ...
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Tables creation `makanbah` db were successful!"); // change this
